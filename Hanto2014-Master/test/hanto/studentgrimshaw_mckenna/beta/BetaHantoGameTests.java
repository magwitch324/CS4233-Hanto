...
public class BetaHantoGameTests {
	...
	public void attemptToMoveRatherThanPlace() throws HantoException {
		game.makeMove(HantoPieceType.BUTTERFLY, new ConcreteHantoCoordinate(0, 1), new ConcreteHantoCoordinate(0, 0));
	}
	...
	public void allPiecesPlaced() throws HantoException {
		...
		// Turn4
		result = game.makeMove(HantoPieceType.BUTTERFLY, null, new ConcreteHantoCoordinate(6, 0));
		assertEquals(MoveResult.OK, result);

		result = game.makeMove(HantoPieceType.BUTTERFLY, null, new ConcreteHantoCoordinate(7, 0));
		assertEquals(MoveResult.OK, result);

		// Turn5
		result = game.makeMove(HantoPieceType.SPARROW, null, new ConcreteHantoCoordinate(8, 0));
		assertEquals(MoveResult.OK, result);

		result = game.makeMove(HantoPieceType.SPARROW, null, new ConcreteHantoCoordinate(9, 0));
		assertEquals(MoveResult.OK, result);

		// Turn6
		result = game.makeMove(HantoPieceType.SPARROW, null, new ConcreteHantoCoordinate(10, 0));
		assertEquals(MoveResult.OK, result);

		result = game.makeMove(HantoPieceType.SPARROW, null, new ConcreteHantoCoordinate(11, 0));
	...
	public void blueWins() throws HantoException {
		...
		// Turn 2
		result = game.makeMove(HantoPieceType.SPARROW, null, new ConcreteHantoCoordinate(0, 1));
		assertEquals(MoveResult.OK, result);

		result = game.makeMove(HantoPieceType.SPARROW, null, new ConcreteHantoCoordinate(1, 1));
		assertEquals(MoveResult.OK, result);
		...
		result = game.makeMove(HantoPieceType.SPARROW, null, new ConcreteHantoCoordinate(2, -1));
		assertEquals(MoveResult.OK, result);
