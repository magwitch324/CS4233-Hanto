...
public class EpsilonHantoMasterTest {
	...
	public void horseJumps() throws HantoException {
		final PieceLocationPair[] board = new PieceLocationPair[] { plPair(BLUE, BUTTERFLY, 0, 0),
				plPair(RED, BUTTERFLY, 0, 1), plPair(BLUE, HORSE, 0, -1), plPair(RED, SPARROW, 0, 2) };
		testGame.initializeBoard(board);
		testGame.setPlayerMoving(BLUE);
		testGame.setTurnNumber(3);
	...
	public void horseTriesToJumpAGap() throws HantoException {
		final PieceLocationPair[] board = new PieceLocationPair[] { plPair(BLUE, BUTTERFLY, 0, 0),
				plPair(RED, BUTTERFLY, -1, 1), plPair(BLUE, HORSE, 1, -1), plPair(RED, SPARROW, -3, 3),
	...
	public void sparrowCausesDisconnectedGroup() throws HantoException {
		final PieceLocationPair[] board = new PieceLocationPair[] { plPair(BLUE, BUTTERFLY, 0, 0),
				plPair(RED, BUTTERFLY, -1, 1), plPair(BLUE, HORSE, 2, -2), plPair(RED, SPARROW, 1, -1) };
		testGame.initializeBoard(board);
	...
	public void horseCausesDisconnectedGroup() throws HantoException {
		final PieceLocationPair[] board = new PieceLocationPair[] { plPair(BLUE, BUTTERFLY, 0, 0),
				plPair(RED, BUTTERFLY, -1, 1), plPair(BLUE, HORSE, 2, -2), plPair(RED, HORSE, 1, -1) };
		testGame.initializeBoard(board);
		testGame.setPlayerMoving(RED);
		testGame.setTurnNumber(3);
	...
	public void blueWins() throws HantoException {
		final PieceLocationPair[] board = new PieceLocationPair[] { plPair(BLUE, BUTTERFLY, 0, 0),
				plPair(RED, BUTTERFLY, 0, 1), plPair(BLUE, HORSE, 0, -1), plPair(RED, HORSE, -1, 2),
				plPair(BLUE, CRAB, -1, 1), plPair(RED, CRAB, 1, 1), plPair(BLUE, SPARROW, -1, 0),
